...
test('list type switch', async t => {
  await t
    ...
    .expect(Selector('ul li:nth-child(2) a').textContent).eql('4 title')
    .wait(1500)
    .expect(Selector('.count').textContent).eql('3')
    ...
    .expect(Selector('ul li:nth-child(2) a').textContent).eql('3 title')
    .wait(1500)
    .expect(Selector('.count').textContent).eql('4')
    .expect(Selector('ul li:nth-child(1) a').textContent).eql('1 title')
    .expect(Selector('ul li:nth-child(2) a').textContent).eql('4 title')
    ...
    .click('button')
    .expect(Selector('.count').textContent).eql('5')
    .expect(Selector('ul li:nth-child(1) a').textContent).eql('1 title')
    .expect(Selector('ul li:nth-child(2) a').textContent).eql('4 title')
    ...
    .click('button')
    .expect(Selector('.count').textContent).eql('6')
    .expect(Selector('ul li:nth-child(1) a').textContent).eql('1 title')
    .expect(Selector('ul li:nth-child(2) a').textContent).eql('4 title')
